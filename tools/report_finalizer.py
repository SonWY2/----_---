...
def main() -> None:
    ...
    parser.add_argument(
        "--core",
        default=".claude/memory/ranked_candidates.json",
        help="Path to ranked core candidates JSON",
    )
    parser.add_argument(
        "--watchlist",
        default=".claude/memory/watchlist_candidates_hardened.json",
        help="Path to hardened watchlist candidates JSON",
    )
    parser.add_argument(
        "--reports-dir",
        default="outputs",
